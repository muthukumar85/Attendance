...
class _registerAdminState extends State<registerAdmin> {
  ...
  void _submit() async{
    ...
    setState(() async{
      await LoginWithCredentials.registerAdminUsingEmailPassword(name: myController3.text, email: myController1.text, password: myController2.text, context: context);
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Admin Account Created Successfully')));
                ...
                child: Container(
                  child: SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          const Text('Register As a Admin',
                            style: TextStyle(
                                color: Colors.purple,
                                fontSize: 30.0,
